...
argv[2]: temporary folder to store age file
argv[3]: temporary folder to store OS file

Optional arguments
-g, --group:    whether group fusion by gene3p or not
...
if __name__ == '__main__':
    ...
    parser.add_argument("temp_folder_age", type=str)
    parser.add_argument("temp_folder_OS", type=str)
    parser.add_argument("-g", "--group", action="store_true")
    args = parser.parse_args()
    file_input = args.file_input
    temp_folder_age = args.temp_folder_age
    temp_folder_OS = args.temp_folder_OS
    ...
    compareallage(fusions,temp_folder_age,group=args.group)
    compareallOS(fusions,temp_folder_OS,group=args.group)
