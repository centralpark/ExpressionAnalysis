'''
Statistical analysis for all gene fusion grouped by gene3p
...
python /pred_cello1/analysis/geneFusion/tcga/integrate/R_scripts/compareDistAllFusion_cluster.py %s %s %s --group
